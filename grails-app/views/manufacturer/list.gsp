			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="manufacturerCode" title="${message(code: 'manufacturer.manufacturerCode.label', default: 'Manufacturer Code')}" />
				...
				<g:each in="${manufacturerInstanceList}" status="i" var="manufacturerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="edit" id="${manufacturerInstance.id}">${fieldValue(bean: manufacturerInstance, field: "manufacturerCode")}</g:link></td>
